(() => {
    ...
    var DomManager = class {
        ...
        replace(replacement) {
            this.el[this.traversals["parent"]].replaceChild(
                replacement,
                this.el
            );
            return replacement;
            ...
            while (currentTo) {
                ...
                if (!currentFrom) {
                    if (toKey && domKeyHoldovers[toKey]) {
                        ...
                        await breakpoint(
                            "Add element: " +
                                (added2.outerHTML || added2.nodeValue)
                        );
                ...
                if (toKey !== domKey) {
                    ...
                    if (toKey && !domKey) {
                        if (domKeyDomNodeMap[toKey]) {
                            currentFrom = dom(currentFrom).replace(
                                domKeyDomNodeMap[toKey]
                            );
